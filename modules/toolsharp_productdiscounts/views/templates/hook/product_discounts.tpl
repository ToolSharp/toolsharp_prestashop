        ...
        <ul class="pd-discounts__list" role="list">
            {foreach from=$pd_discounts item=discount}
                <li class="pd-discount pd-discount--{$discount.type}">
                    ...
                    <div class="pd-discount__code-wrap">
                        <button class="pd-discount__code" type="button" data-code="{$discount.code|escape:'html':'UTF-8'}"
             ...
             *}
                    <button class="pd-discount__info-btn" type="button"
                        ...
                        data-pd-info="{$discount.info_json|escape:'htmlall':'UTF-8'}">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
   ...
   ===================================================================== *}
    ...
    <script>
        ...
        ---------------------------------------------------------------- */
            ...
            /* ---- Inline card copy buttons ---- */
            document.querySelectorAll('.pd-discount__code[data-code]').forEach(function(btn) {
                btn.addEventListener('click', function() { copyToClipboard(btn.dataset.code, btn); });
            });
        ...
        ---------------------------------------------------------------- */
            ...
            document.querySelectorAll('.pd-discount__info-btn').forEach(function(btn) {
                btn.addEventListener('click', function() {
                    try {
                        openModal(JSON.parse(btn.dataset.pdInfo));
                    } catch (e) {
            ...
            if (overlay) {
                ...
                document.addEventListener('keydown', function(e) {
                    if (!overlay.hidden && (e.key === 'Escape' || e.key === 'Esc')) closeModal();
                });
